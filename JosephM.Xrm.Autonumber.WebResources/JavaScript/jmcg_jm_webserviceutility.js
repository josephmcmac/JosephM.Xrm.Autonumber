...
JosephMServiceUtility = function () {
    var that = this;
    this.FieldType =
    {
    ...
    this.RetrieveMultipleAsync = function (entityType, fields, conditions, orders, asyncCallback) {
    ...
    function HttpContainer(httpReq, onSuccess, onError) {
        ...
        this.OnStateChange = function () {
            ...
            if (that.HttpReq.status != 200) {
                ...
                that.OnSuccess(that.HttpReq.responseText);
            }
        }
    }
    ...
    this.Fetch = function (fetch, asyncCallback) {
        ...
        executerequestxml += EncodeHTML(fetch);
        executerequestxml += "</a:Query>";
        executerequestxml += "</b:value>";
        executerequestxml += "</a:KeyValuePairOfstringanyType>";
        executerequestxml += "</a:Parameters>";
...
josephMUtility = new JosephMServiceUtility();